...
<div class="page-shell">
    <div class="page-header">
        <div>
            <p class="muted-link" style="text-transform: uppercase; letter-spacing: 0.08em;">Update Tenant</p>
            <h1>Edit {{ $tenant->name }}</h1>
            <p>Refresh contact details to keep billing records accurate.</p>
        </div>
        <a href="{{ route('tenants.show', $tenant) }}" class="btn btn-ghost">Cancel</a>
    </div>
    ...
    <div class="panel">
        ...
        <form method="POST" action="{{ route('tenants.update', $tenant) }}">
            ...
            <div class="form-control" style="margin-top: 12px;">
                ...
                <textarea name="address" id="address" rows="3">{{ old('address', $tenant->address) }}</textarea>
            </div>
